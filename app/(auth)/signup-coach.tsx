      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Great coaches build great athletes</Text>
          </View>
          ...
          {showOptional && (
            <View style={styles.form}>
              ...
              <Input
                ...
                icon={<ClipboardList size={20} color={theme.colors.textSecondary} />}
                testID="coach-experience"
              />
              <Input
                label="Coaching Philosophy"
                placeholder="Describe your coaching approach and style"
                value={philosophy}
                onChangeText={setPhilosophy}
                multiline
                icon={<Quote size={20} color={theme.colors.textSecondary} />}
                testID="coach-philosophy"
              />
              <Input
                label="Team History"
                placeholder="Previous teams coached (comma separated)"
                value={teamHistory}
                onChangeText={setTeamHistory}
