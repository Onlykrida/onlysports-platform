      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Your expertise transforms athletes</Text>
          </View>
          ...
          {showOptional && (
            <View style={styles.form}>
              ...
              <Input
                label="Specialties"
                placeholder="e.g., Strength Training, Conditioning, Sports Rehab"
                value={specialties}
                onChangeText={setSpecialties}
                icon={<Dumbbell size={20} color={theme.colors.textSecondary} />}
                testID="trainer-specialties"
              />
              <Input
                label="Certifications"
                placeholder="e.g., ACE, NSCA, ACSM (comma separated)"
                value={certifications}
                onChangeText={setCertifications}
                icon={<Award size={20} color={theme.colors.textSecondary} />}
                testID="trainer-certs"
              />
              <Input
                label="City, Country"
