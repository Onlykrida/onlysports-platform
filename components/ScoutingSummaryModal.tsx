...
export function ScoutingSummaryModal({ visible, onClose, user }: ScoutingSummaryModalProps) {
  ...
  const generateSummary = async () => {
    ...
    try {
      ...
      const prompt = `You are a professional sports scout. Create a concise 4-6 line scouting summary suitable for coaches and scouts.

Player:
Name: ${user.name}
Age: ${age}
City: ${user.location || 'Not specified'}
        ...
        <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.documentHeader}>
            <View style={styles.documentTitleContainer}>
              ...
              <Text style={styles.documentTitle}>PROFESSIONAL SCOUTING SUMMARY</Text>
            </View>
          ...
          <View style={styles.summarySection}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionTitle}>SCOUTING ASSESSMENT</Text>
            </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              ...
              Final evaluations should include in-person assessment.
            </Text>
            <Text style={styles.footerConfidential}>CONFIDENTIAL • FOR SCOUTING USE ONLY</Text>
          </View>
        </ScrollView>
