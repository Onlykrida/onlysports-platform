...
export const [FitnessTestProvider, useFitnessTest] = createContextHook<FitnessTestContextValue>(
  () => {
    ...
    const saveSprintResult = useCallback(
      async (data: {
        ...
        try {
          ...
          const testType: FitnessTestType =
            data.sprint_distance === 20 ? 'sprint_20m' : 'sprint_40m';
