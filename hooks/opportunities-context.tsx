...
const OPPORTUNITIES_DEFAULTS: OpportunitiesState = {
  opportunities: [],
  myApplications: [],
  ...
  loadReceivedApplications: async () => {},
  refreshOpportunities: async () => {},
};

const [OpportunitiesProvider, _useOpportunities] = createContextHook<OpportunitiesState>(() => {
  const { user } = useAuth();
...
export { OpportunitiesProvider };
export const useOpportunities = () => _useOpportunities() ?? OPPORTUNITIES_DEFAULTS;
