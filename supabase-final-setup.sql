...
-- This script safely handles existing tables and creates missing ones
...
-- Success message
SELECT 'OnlySports database setup completed successfully! All tables, policies, and triggers are now configured.' as status;